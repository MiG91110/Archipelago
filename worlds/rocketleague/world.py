...
from . import options as rocketleague_options  # rename due to a name conflict with World.options
...
class rocketleagueWorld(World):
    """
    Rocket League crosses Soccer with Arcade racing.
    Get ready to drive, score and fly
    """
    ...
    web = web_world.rocketleagueWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "apquest_options" at the top of this file to avoid a name conflict)
    options_dataclass = rocketleague_options.rocketleagueOptions
    options: rocketleague_options.rocketleagueOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.rocketleagueItem:
