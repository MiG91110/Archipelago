...
def set_all_entrance_rules(world: APQuestWorld) -> None:
    ...
    freeplay_to_botmatch = world.get_entrance("Freeplay to bot match")
    ...
    def has_boost(state: CollectionState) -> bool:
        return state.has("Boost", world.player)
    ...
    set_rule(freeplay_to_botmatch, has_boost)
    ...
    if world.options.workshop:
        freeplay_to_workshop = world.get_entrance("Freeplay to workshopmap1")
        set_rule(freeplay_to_workshop, lambda state: state.has("Boost", world.player))
