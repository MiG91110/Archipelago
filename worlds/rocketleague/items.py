...
DEFAULT_ITEM_CLASSIFICATIONS = {
    "Boost Capacity 1": ItemClassification.progression,
    #"Sword": ItemClassification.progression | ItemClassification.useful,  # Items can have multiple classifications.
    "Workshop Access Codes": ItemClassification.progression,
    #"Health Upgrade": ItemClassification.useful,
    "Full Boost": ItemClassification.filler,
    "Boost Empty Trap": ItemClassification.trap,
}


# Each Item instance must correctly report the "game" it belongs to.
# To make this simple, it is common practice to subclass the basic Item class and override the "game" field.
class rocketleagueItem(Item):
    game = "rocketleague"
...
def get_random_filler_item_name(world: rocketleagueWorld) -> str:
    ...
    if world.random.randint(0, 99) < world.options.trap_chance:
        return "Boost Empty Trap"
    return "Full Boost"


def create_item_with_correct_classification(world: rocketleagueWorld, name: str) -> rocketleagueItem:
    ...
    return rocketleagueItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


# With those two helper functions defined, let's now get to actually creating and submitting our itempool.
def create_all_items(world: rocketleagueWorld) -> None:
    ...
    itempool: list[Item] = [
        world.create_item("Boost Capacity 1"),
    ]
    ...
    if world.options.workshop:
        ...
        itempool.append(world.create_item("Workshop Access Codes"))
